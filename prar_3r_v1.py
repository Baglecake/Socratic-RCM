...
Original file is located at
    https://colab.research.google.com/drive/1oNddmNvzCdUaVlMd09fCePDzQYu4lJX_
...
!python /content/Socratic-RCM/agents/agent_runner.py \
  --state /content/Socratic-RCM/prar/outputs/2025-11-23_baseline_full_qwen/state.json \
  --output /content/Socratic-RCM/simulation_test \
  --provider vllm \
  --base-url http://127.0.0.1:8000/v1 \
  --model Qwen/Qwen2.5-7B-Instruct \
  --max-turns 5
